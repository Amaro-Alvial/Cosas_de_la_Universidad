...
if __name__=="__main__":
    ...
    def Borrar():
        ...
        texto=e_texto.get()
        largo=len(texto)
        largo_id=len(texto_id)

        if (largo>=1 and texto[i-1]=="i" and texto_id[largo_id-1]=="p"):
        ...
        if(largo>=1 and texto[i-1]== "t" and texto_id[largo_id-1]=="R"):
        ...
        if(largo>=2 and texto[i-2]== "*" and texto[i-1]== "*" and texto_id[largo_id-1]=="P"):
        ...
        if(largo>=3 and texto[i-3]== "g" and texto[i-2]== "1" and texto[i-1]== "0" and texto_id[largo_id-1]=="l"):
        ...
        if(largo>=1 and texto[i-1] == "g" and texto_id[largo_id-1]=="L"):
        ...
        if(largo>=1 and texto[i-1] == "n" and texto_id[largo_id-1]=="S"):
            e_texto.delete(i-5,END)
            i-=5
            e1_texto.delete(e-3,END)
            e-=3
        ...
        if(largo>=1 and texto[i-1] == "s" and texto_id[largo_id-1]=="C"):
            e_texto.delete(i-5,END)
            i-=5
            e1_texto.delete(e-3,END)
            e-=3
        ...
        if(largo>=1 and texto[i-1] == "n" and texto_id[largo_id-1]=="T"):
            e_texto.delete(i-5,END)
            i-=5
            e1_texto.delete(e-3,END)
            e-=3
        ...
        if(largo>=1 and texto[i-1] == "e" and texto_id[largo_id-1]=="e"):
    ...
    ventana.iconbitmap("7007513_finance_calculator_accounting_business_icon.ico")
